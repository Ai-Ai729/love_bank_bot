...
MENU = [
    ...
    ("СЕКРЕТНЫЙ СУПЕРПРИЗ 💃 (готовься... P.S. Перед активацией приготовь секретное слово - спрятано на одной из купюр 🤗)",     5000,  "jackpot"),
]
...
async def callbacks(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if action == "confirm":
        ...
        if p_code == "cashout100":
            extra = "\n🧾 Жди подтверждения."
        if p_code == "jackpot":
            extra = "\n💃 Суперприз активирован! Приготовь секретное слово и жди сообщение - сюрприз 😉"
